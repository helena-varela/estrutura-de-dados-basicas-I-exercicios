...
4. **Encontrar a Raiz Quadrada Inteira de um Número** (`raizQuadradaInteira.cpp`) OK
...
7. **Encontrar a Posição de Inserção de um Elemento** (`posicaoInsercao.cpp`) OK
...
8. **Encontrar o Elemento Mais Próximo** (`encontrarElementoProximo.cpp`) OK, NAO ENTENDI BEM!
